...
def _lr_rotate(root, node):
    root = _left_rotate(root, node.left)
    root = _right_rotate(root, node)
    return root


def _rl_rotate(root, node):
    root = _right_rotate(root, node.right)
    root = _left_rotate(root, node)
    return root
...
if __name__ == "__main__":
    ...
    # Test 7
    print("=" * 50)
    print("Test 7 - Expected: Case #3b")
    print("=" * 50)
    root7 = None
    root7 = insert(10, root7, False)
    root7 = insert(15, root7, False)
    root7 = insert(12, root7, True)
    print_tree(root7)
    print()